...
export default function OurStoryPage() {
  ...
  const timelineSteps = timeline.timelineSteps || defaultTimelineSteps;
    ...
    <div ref={containerRef} className="min-h-screen bg-white overflow-x-hidden">
      ...
      >
        ...
        <div ref={bgRef} className="absolute inset-0 z-0 scale-110">
          <Image
            src={hero.backgroundImage || "/images/assets/SEVEN_STARS_2026_02_09-0112.jpg"}
            alt="Our Story"
            fill
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-end">
            ...
            <div className="md:col-span-5 lg:col-span-4 pb-2 md:pb-4">
              <p className="hero-reveal text-white/80 font-light text-sm md:text-base leading-relaxed border-l border-[#475DB1]/50 pl-6">
                {hero.description || "Discover the rich history of the Seven Stars—saved by the community, for the community. A true village pub where every pint pours a story of resilience, joy, and shared moments since 2013."}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="pt-24 md:pt-32 pb-8 bg-white relative">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal-section relative z-10">
          <span className="text-[10px] tracking-[0.4em] text-[#475DB1] uppercase font-medium flex items-center justify-center gap-3 mb-6">
            ...
            {intro.introTagline || "Our Story"}
            <span className="w-8 h-[1px] bg-[#475DB1]"></span>
          </span>
          <h2 className="text-4xl md:text-5xl font-serif text-slate-900 leading-tight mb-8">
            {intro.introHeading || "A Community That Creates"}{" "}
            <em className="text-[#475DB1] font-light">{intro.introHeadingItalic || "Happy Moments"}</em>
          </h2>
          <p className="text-lg sm:text-xl text-slate-600 font-light leading-relaxed max-w-3xl mx-auto">
            {intro.introDesc || "Our story began when we started looking for ways to bring people together. These community members shared a common interest and shared purpose."}
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="reveal-section lg:col-span-6 space-y-8">
              <div className="space-y-4">
                <span className="text-[10px] tracking-[0.4em] text-[#475DB1] uppercase font-medium flex items-center gap-3">
                  <span className="w-8 h-[1px] bg-[#475DB1]"></span>
                  {hub.hubTagline || "Community Hub"}
                </span>
                <h2 className="text-4xl md:text-5xl font-serif text-slate-900 leading-tight">
                  {hub.hubHeading || "A Pub By the People,"} <br />
                  <em className="text-[#475DB1] font-light">{hub.hubHeadingItalic || "For the People"}</em>
                </h2>
              </div>

              <div className="space-y-6 text-lg text-slate-600 font-light leading-relaxed">
                <p>
                  {hub.hubDesc1 || "We are truly community-owned, bought by the community and restored by it. This takes our attention away from short-term profit to long-term stability."}
                </p>
                <p>
                  {hub.hubDesc2 || "Our doors are open to both locals and visitors alike. The love showered by our people has made us so resilient. We are always going to be a people-first pub, delivering quality food and warm service to guests."}
                </p>
                <p>
                  {hub.hubDesc3 || "We value our community members who not only saved us but are continually helping us grow by supporting in-house events."}
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-slate-100 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 mb-1">
                    {hub.cardTitle || "Expect More Experiences"}
                  </h4>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    {hub.cardDesc || "You can also expect quiz nights, live music and seasonal activities. Join us for great food, great beer, and a true village pub experience in Oxfordshire."}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="reveal-section lg:col-span-6">
              <div className="relative h-[400px] md:h-[450px] rounded-3xl overflow-hidden shadow-2xl mb-8 group">
                <Image
                  src={hub.rightImage || "/images/assets/SEVEN_STARS_2026_02_09-0001.jpg"}
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl md:text-3xl font-serif italic font-light">
                    {hub.rightImageTitle || "Our experiences look like:"}
                  </h3>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                  ...
                  <span className="font-medium text-slate-800 text-sm">
                    {hub.exp1 || "Friends catching up over a pint"}
                  </span>
                </div>
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                  <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-[#475DB1] shrink-0">
                  ...
                  <span className="font-medium text-slate-800 text-sm">
                    {hub.exp2 || "Families enjoying Sunday lunch"}
                  </span>
                </div>
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                  <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-[#475DB1] shrink-0">
                  ...
                  <span className="font-medium text-slate-800 text-sm">
                    {hub.exp3 || "Neighbours celebrating special moments"}
                  </span>
                </div>
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                  <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-[#475DB1] shrink-0">
                  ...
                  <span className="font-medium text-slate-800 text-sm">
                    {hub.exp4 || "Visitors discovering a true village pub"}
                  </span>
                </div>
              </div>
            </div>
