...
export default function OutdoorSeating() {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-[40%] space-y-8">
            <h2 className="text-7xl font-serif text-slate-900 tracking-tighter leading-none">
              Outdoor <br />
              <span className="text-[#475DB1]">Seating</span>
            </h2>
            <p className="text-neutral-600 font-light leading-relaxed max-w-md">
              Welcome to Seven Stars, where culinary excellence meets a serene
              and inviting ambiance. Nestled in the heart of the village, our
              restaurant offers a delightful escape from the hustle and bustle,
              providing a perfect setting for any occasion.
            </p>
            <Link
              href="/contact"
