...
export default function Footer() {
  ...
  return (
    <footer
      ref={ref}
      className="relative bg-dark-990 border-t border-dark-900 overflow-hidden"
    >
      {/* Large watermark word */}
      <div
        className="footer-watermark absolute bottom-0 left-1/2 -translate-x-1/2 text-[12rem] md:text-[18rem] font-serif text-dark-900/30 select-none pointer-events-none leading-none tracking-tighter whitespace-nowrap
       "
        style={{ opacity: 0.5 }}
      >
        SEVEN STARS
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-dark-800/60">
          ...
          <div className="footer-col space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              <a
                href="#"
                className="w-9 h-9 rounded-full border border-dark-800 flex items-center justify-center text-dark-500 hover:text-gold-500 hover:border-gold-600/50 transition-all"
              >
                <Instagram size={15} />
              </a>
              <a
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-dark-400 hover:text-gold-400 text-sm font-light transition-colors"
                >
                  +44 1234 567 890
                </a>
              </li>
        ...
        <div className="footer-bottom py-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="#"
              className="text-[10px] text-dark-600 hover:text-gold-500 uppercase tracking-widest transition-colors"
            >
              Privacy Policy
            </Link>
