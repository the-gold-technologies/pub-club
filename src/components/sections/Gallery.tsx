    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.gallery-header',
        ...
        { y: 0, opacity: 1, duration: 0.9, ease: 'power3.out',
          scrollTrigger: { trigger: '.gallery-header', start: 'top 82%', toggleActions: 'play none none none' }
        }
      );
      ...
      gsap.fromTo('.gallery-item',
        ...
        { y: 0, opacity: 1, scale: 1, duration: 0.75, stagger: 0.15, ease: 'power3.out',
          scrollTrigger: { trigger: '.gallery-item', start: 'top 82%', toggleActions: 'play none none none' }
        }
      );
    }, ref);
    ...
    <section ref={ref} id="gallery" className="py-24 bg-dark-990 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="gallery-header mb-16 flex items-end justify-between border-b border-dark-800/60 pb-8">
          <div className="flex flex-col gap-3">
            <span className="text-[10px] tracking-[0.4em] text-gold-600 uppercase font-medium flex items-center gap-3">
              <span className="font-serif text-2xl text-dark-700 leading-none">04</span>
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-white leading-tight tracking-tight">
              Our <em className="not-italic italic text-gold-500 font-light">Gallery</em>
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {images.map((img, i) => (
            <div key={i} className={`gallery-item relative h-80 rounded-2xl overflow-hidden group cursor-pointer ${i === 2 || i === 3 ? "sm:col-span-2 lg:col-span-1" : ""}`}>
